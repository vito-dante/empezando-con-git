...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-07-2014 a las 13:14:35
...
('65456', 'rodriga', 'menacho', '159785', 'debajo de una piedra'),
...
INSERT INTO `inventario` (`ID_INVENTARIO`, `CANTIDAD_STOCK`, `FECHA_INV`) VALUES
(1, 40, '2014-07-15'),
(2, 50, '2014-07-15');
...
INSERT INTO `producto` (`COD_PROD`, `ID_CATEGORIA`, `ID_INVENTARIO`, `ID_ESTADO`, `CANTIDAD`, `OBSERVACION`, `FECHA_INGRESO`, `FECHA_MODIFICACION`) VALUES
('bolsita', 3, 1, 1, 40, 'nnn', '2014-07-03', NULL),
('Castaña derivado', 2, 2, 1, 50, 'ninguna', '2014-07-15', NULL),
('jugo de frutas', 1, 1, 1, 40, 'ninguna', '2014-07-15', NULL);
